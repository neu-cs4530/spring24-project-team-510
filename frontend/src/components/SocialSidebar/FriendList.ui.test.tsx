...
describe('FriendList', () => {
  describe('Friend List tab', () => {
    test('The tab is rendered', async () => {
      await waitFor(() => {
        expect(screen.getByRole('tab', { name: /Friend List/i })).toBeInTheDocument();
      });
    });
  ...
  describe('My Group tab', () => {
    test('The tab is rendered', async () => {
      await waitFor(() => {
        expect(screen.getByRole('tab', { name: /My Group/i })).toBeInTheDocument();
      });
    });
    describe('When clicked', () => {
      it('Goes to the My Group page', async () => {
        ...
        await waitFor(() => {
          expect(screen.getByText(/No Group Members/i)).toBeInTheDocument();
        });
        await waitFor(() => {
